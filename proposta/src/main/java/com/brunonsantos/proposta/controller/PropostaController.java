...
public class PropostaController {
	...
	public ResponseEntity<Proposta> criarProposta(@ApiParam(value = "Dados para criar um novo cliente") @RequestBody CriarPropostaDTO params) {
	...
	@GetMapping(value = "/listarPropostas", produces = "application/json")
	public ResponseEntity<Page<Proposta>> listarPropostas(Pageable pageable){
		return ResponseEntity.ok().body(this.propostaService.listarPropostas(pageable));
	}
